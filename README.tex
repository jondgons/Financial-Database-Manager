...
\author{Cody Gonsowski and Trever Hall}% <-this % stops a space
...
\quad Graphical representation of data for the current view (perhaps a pie chart).

\smallskip

\quad A fullscreen clickable calendar that allows the user to navigate through years all the way down to a specific day. It will be more of a "pretty" way to navigate the information, but not edit.
